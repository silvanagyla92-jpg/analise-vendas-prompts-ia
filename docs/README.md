...
3. Elaboração dos prompts;
4. Aplicação dos prompts na ferramenta de IA;
5. Registro das respostas;
6. Verificação dos resultados com os dados;
7. Identificação dos insights;
8. Formulação das recomendações;
